    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            embed = discord.Embed(
                ...
                description=
                f"Great! Your character name has been set to **{self.character_name.value}**.\n\nNow, please select your class:",
                color=0x0099ff)
            ...
            await interaction.response.send_message(embed=embed,
                                                    ...
                                                    ephemeral=True)
            logger.info(
                f"Character name set for {interaction.user.display_name}: {self.character_name.value}"
            )
            ...
            await interaction.response.send_message(
                ...
                ephemeral=True)
            logger.error(
                f"Failed to set nickname for {interaction.user.display_name}: Permission denied"
            )
...
class VerificationView(ui.View):
    ...
    @ui.button(label="Start Verification",
    ...
    async def start_verification(self, interaction: discord.Interaction,
        ...
        logger.info(
            f"Verification started for user: {interaction.user.display_name}")
...
class ClassSelectionView(ui.View):
    ...
    def __init__(self):
        ...
        for class_name, role_id in CLASS_ROLES.items():
            button = ui.Button(label=class_name,
            ...
            try:
                ...
                if role:
                    ...
                    embed = discord.Embed(
                        ...
                        description=
                        f"Excellent! You've been assigned the **{class_name}** class.\n\nNow, please select your preferred role:",
                        color=0xff9900)
                    ...
                    await interaction.response.edit_message(embed=embed,
                                                            view=view)
                    logger.info(
                        f"Class {class_name} assigned to {interaction.user.display_name}"
                    )
                    ...
                    await interaction.response.send_message(
                        ...
                        ephemeral=True)
                    logger.error(
                        f"Role not found: {class_name} (ID: {role_id})")
                ...
                await interaction.response.send_message(
                    ...
                    ephemeral=True)
                logger.error(
                    f"Failed to assign role {class_name}: Permission denied")
            except Exception as e:
                await interaction.response.send_message(
...
class RoleSelectionView(ui.View):
    ...
    def __init__(self):
        ...
        for role_name, role_id in GAMEPLAY_ROLES.items():
            button = ui.Button(label=role_name,
        ...
        async def callback(interaction: discord.Interaction):
            try:
                ...
                if role:
                    ...
                    logger.info(
                        f"Verification completed for {interaction.user.display_name} with role {role_name}"
                    )
                    ...
                    await interaction.response.send_message(
                        ...
                        ephemeral=True)
                    logger.error(
                        f"Role not found: {role_name} (ID: {role_id})")
                ...
                await interaction.response.send_message(
                    ...
                    ephemeral=True)
                logger.error(
                    f"Failed to assign role {role_name}: Permission denied")
            except Exception as e:
                await interaction.response.send_message(
